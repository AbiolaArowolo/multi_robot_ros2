...
def generate_launch_description():
    ...
    tb3_bridge = Node(
        ...
        arguments=[
            ...
            '/model/turtlebot3/odometry@nav_msgs/msg/Odometry@ignition.msgs.Odometry',
            '/model/turtlebot3/scan@sensor_msgs/msg/LaserScan@ignition.msgs.LaserScan',
            '/model/turtlebot3/joint_states@sensor_msgs/msg/JointState@ignition.msgs.Model',
            '/model/turtlebot3/tf@tf2_msgs/msg/TFMessage@ignition.msgs.Pose_V',
        ],
        remappings=[
            ('/cmd_vel', '/cmd_vel'),
            ('/model/turtlebot3/odometry', '/odom'),
            ('/model/turtlebot3/scan', '/scan'),
